...
using System.Data;
namespace Dash_Board.Data_Layer
{
    public class DatabaseConnections
    {
        ...
        public bool Connect()
        {
            try
            {
                strSqlConn = "Data Source=" + Dash_Board.Entity_Layer.DatabaseSettings.SqldbServer + ";initial catalog=" + Dash_Board.Entity_Layer.DatabaseSettings.SqlDBName + "; Integrated Security=false;User ID=" + Dash_Board.Entity_Layer.DatabaseSettings.SqlDBUserID + ";PWD=" + Dash_Board.Entity_Layer.DatabaseSettings.SqlDBPassword;
