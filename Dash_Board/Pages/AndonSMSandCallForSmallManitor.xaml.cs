...
namespace Dash_Board.Pages
{
    ...
    /// </summary>
    public partial class AndonSMSandCallForSmallManitor : Window
    {
        ...
        private void Window_Loaded(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                ////System.Windows.MessageBox.Show(se[1].WorkingArea.Width.ToString());

                //for (int i = 0; i < se.Length; i++)
                //{
                //    if (se[i].WorkingArea.Width < 1920)
                //    {
                //        this.Width = se[i].WorkingArea.Width + 50;
                //        this.Height = se[i].WorkingArea.Height + 50;
                //    }
                //}
                this.Width =1024 + 50;
                this.Height =779 + 50;
                ...
                //}
                // CommonClasses.CommonMethods.MessageBoxShow(se.Length.ToString(), CustomMessageBox.CustomStriing.Error.ToString(), CustomMessageBox.CustomStriing.OK.ToString());

                var desktopWorkingArea = System.Windows.SystemParameters.WorkArea;
                this.Left = desktopWorkingArea.Right - this.Width + Convert.ToInt32(1075);
               // this.Left = 500;
